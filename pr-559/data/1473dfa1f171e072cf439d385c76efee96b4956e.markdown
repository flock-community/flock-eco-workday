...
Locator: getByRole('cell', { name: 'E2E editable project 1783089793204 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783089793204 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783089786395":
        - cell:
          - button
        - cell "E2E created project 1783089786395"
        - cell:
          - button
      - row "E2E editable project 1783089793204":
        - cell:
          - button
        - cell "E2E editable project 1783089793204"
        - cell:
          - button
```
