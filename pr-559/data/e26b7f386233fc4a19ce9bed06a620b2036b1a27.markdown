...
Locator: getByRole('cell', { name: 'E2E editable project 1783118663009 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783118663009 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783118655765":
        - cell:
          - button
        - cell "E2E created project 1783118655765"
        - cell:
          - button
      - row "E2E editable project 1783118663009":
        - cell:
          - button
        - cell "E2E editable project 1783118663009"
        - cell:
          - button
```
