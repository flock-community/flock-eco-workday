...
Locator: getByRole('cell', { name: 'E2E editable project 1783098440624 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783098440624 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783098433623":
        - cell:
          - button
        - cell "E2E created project 1783098433623"
        - cell:
          - button
      - row "E2E editable project 1783098440624":
        - cell:
          - button
        - cell "E2E editable project 1783098440624"
        - cell:
          - button
```
