...
Locator: getByRole('cell', { name: 'E2E editable project 1783173028492 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783173028492 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783173021650":
        - cell:
          - button
        - cell "E2E created project 1783173021650"
        - cell:
          - button
      - row "E2E editable project 1783173028492":
        - cell:
          - button
        - cell "E2E editable project 1783173028492"
        - cell:
          - button
```
...
```ts
  ...
  26  |     await expect(page.getByRole('heading', { name: 'Projects' })).toBeVisible();
  27  |     await expect(
