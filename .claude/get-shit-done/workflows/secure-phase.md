...
```
Agent(
  prompt="Read /Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/get-shit-done/templates/SECURITY.md`
