...
```markdown
Read /Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/agents/gsd-eval-planner.md for instructions.
