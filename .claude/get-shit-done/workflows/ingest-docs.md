...
```bash
INIT=$(node "/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
