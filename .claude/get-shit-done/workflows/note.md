...
- **Global scope**: `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/notes/`)
...
2. Glob `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/notes/` — works in any directory
