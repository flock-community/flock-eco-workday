...
The keys live in `.claude/settings.json` (project) or `/Users/julius.van.dis/IdeaProjects/Flock/flock-eco-workday/.claude/settings.json` (global) — **not** in `.planning/config.json`:
