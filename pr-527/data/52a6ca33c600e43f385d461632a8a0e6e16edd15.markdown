...
Locator: getByRole('cell', { name: 'E2E editable project 1781782504599 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1781782504599 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1781782497767":
        - cell:
          - button
        - cell "E2E created project 1781782497767"
        - cell:
          - button
      - row "E2E editable project 1781782504599":
        - cell:
          - button
        - cell "E2E editable project 1781782504599"
        - cell:
          - button
```
