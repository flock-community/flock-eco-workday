...
Error: strict mode violation: getByText('Projects') resolved to 2 elements:
    1) <span class="MuiBox-root css-1gz4ws5">Projects</span> aka getByRole('link', { name: 'Projects' })
    2) <span class="MuiTypography-root MuiTypography-h5 MuiCardHeader-title css-1uzvym2-MuiTypography-root">Projects</span> aka getByText('Projects').nth(1)
