...
Locator: getByRole('cell', { name: 'E2E editable project 1782483521639 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782483521639 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782483513592":
        - cell:
          - button
        - cell "E2E created project 1782483513592"
        - cell:
          - button
      - row "E2E editable project 1782483521639":
        - cell:
          - button
        - cell "E2E editable project 1782483521639"
        - cell:
          - button
```
