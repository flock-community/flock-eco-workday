# Requirements Archive: v1.0 Budget Allocations
...
- **ENH-04**: StudyMoney file download links — render download UI for uploaded receipts/attachments (backend endpoint + client function ready)
