...
Locator: getByRole('cell', { name: 'E2E editable project 1783330544994 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783330544994 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783330537378":
        - cell:
          - button
        - cell "E2E created project 1783330537378"
        - cell:
          - button
      - row "E2E editable project 1783330544994":
        - cell:
          - button
        - cell "E2E editable project 1783330544994"
        - cell:
          - button
```
