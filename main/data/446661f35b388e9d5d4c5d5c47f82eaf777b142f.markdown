...
Locator: getByRole('cell', { name: 'E2E editable project 1781787324795 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1781787324795 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1781787316891":
        - cell:
          - button
        - cell "E2E created project 1781787316891"
        - cell:
          - button
      - row "E2E editable project 1781787324795":
        - cell:
          - button
        - cell "E2E editable project 1781787324795"
        - cell:
          - button
```
