...
Locator: getByRole('cell', { name: 'E2E editable project 1787557898440 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1787557898440 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1787557891943":
        - cell:
          - button
        - cell "E2E created project 1787557891943"
        - cell:
          - button
      - row "E2E editable project 1787557898440":
        - cell:
          - button
        - cell "E2E editable project 1787557898440"
        - cell:
          - button
```
