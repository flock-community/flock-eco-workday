...
Locator: getByRole('cell', { name: 'E2E editable project 1789585732503 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1789585732503 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1789585726275":
        - cell:
          - button
        - cell "E2E created project 1789585726275"
        - cell:
          - button
      - row "E2E editable project 1789585732503":
        - cell:
          - button
        - cell "E2E editable project 1789585732503"
        - cell:
          - button
```
