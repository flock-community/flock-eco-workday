...
Locator: getByRole('cell', { name: 'E2E editable project 1782289079088 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782289079088 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782289071360":
        - cell:
          - button
        - cell "E2E created project 1782289071360"
        - cell:
          - button
      - row "E2E editable project 1782289079088":
        - cell:
          - button
        - cell "E2E editable project 1782289079088"
        - cell:
          - button
```
