...
Locator: getByRole('cell', { name: 'E2E editable project 1783171558708 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1783171558708 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1783171551434":
        - cell:
          - button
        - cell "E2E created project 1783171551434"
        - cell:
          - button
      - row "E2E editable project 1783171558708":
        - cell:
          - button
        - cell "E2E editable project 1783171558708"
        - cell:
          - button
```
