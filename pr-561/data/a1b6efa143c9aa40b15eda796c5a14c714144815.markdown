...
Locator: getByRole('cell', { name: 'E2E editable project 1782826395405 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782826395405 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782826388499":
        - cell:
          - button
        - cell "E2E created project 1782826388499"
        - cell:
          - button
      - row "E2E editable project 1782826395405":
        - cell:
          - button
        - cell "E2E editable project 1782826395405"
        - cell:
          - button
```
