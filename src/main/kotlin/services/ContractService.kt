...
class ContractService(
    ...
    @Transactional
    fun create(form: ContractServiceForm): ContractServiceModel? =
        form
            .internalize()
            .save()
    ...
    private fun ContractServiceForm.internalize(it: ContractServiceModel? = null) =
        ContractServiceModel(
            id = it?.id ?: 0,
            from = this.from,
            to = this.to,
