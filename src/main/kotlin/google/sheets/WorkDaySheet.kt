...
class WorkDaySheet(
    ...
    private fun replaceSimpleTags(id: String, workday: WorkDay) {
        sheets.findAndReplaceCellByTag(id, Tag.ASSIGNMENT_DEVELOPER_FULL_NAME.value, workday.assignment.person.getFullName())
