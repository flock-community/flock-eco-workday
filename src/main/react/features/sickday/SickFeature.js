...
export function SickdayFeature() {
  ...
  return (<div className={classes.root}>
    ...
    <Grid container spacing={1}>
      ...
      <Grid item xs={12}>
        <SickdayList userCode={userCode} refresh={refresh} onClickRow={handleClickRow}/>
      </Grid>
    </Grid>
    <SickdayDialog open={open} userCode={userCode} value={value} onComplete={handleCompleteDialog}/>
