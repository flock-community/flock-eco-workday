...
export const filterTransitionsFromByStatus = (statusToFilter, allowedStatusTransitions = allStatusTransitions) =>
    allowedStatusTransitions
        .filter(transitionStateProp => transitionStateProp.from === statusToFilter)
        .map(it => it.to)

export const canChangeStatus = (oldValue, newValue, allowedStatusTransitions = allStatusTransitions) => {
    const possibleTransitionsForOldValue = filterTransitionsFromByStatus(oldValue, allowedStatusTransitions);
