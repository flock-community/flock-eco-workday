...
import {allStatusTransitions, canChangeStatus, filterTransitionsFromByStatus} from "./StatusMethods";
...
export function StatusSelect({onChange, value}) {
    ...
    const currentStateOptions = filterTransitionsFromByStatus(value, statusTransitions);
