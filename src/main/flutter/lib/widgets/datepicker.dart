  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        var dayText = Text(localizations.formatDecimal(day), style: itemStyle);

        var badge = !dateLabels.containsKey(dayToBuild)
            ? dayText
            : Stack(
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Semantics(
              ...
              child: ExcludeSemantics(child: disabled ? dayText : badge),
            ),
          ),
        );
