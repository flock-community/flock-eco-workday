...
Locator: getByRole('cell', { name: 'E2E editable project 1782469443559 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782469443559 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782469436292":
        - cell:
          - button
        - cell "E2E created project 1782469436292"
        - cell:
          - button
      - row "E2E editable project 1782469443559":
        - cell:
          - button
        - cell "E2E editable project 1782469443559"
        - cell:
          - button
```
