...
Locator: getByRole('cell', { name: 'E2E editable project 1781799705380 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1781799705380 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1781799698095":
        - cell:
          - button
        - cell "E2E created project 1781799698095"
        - cell:
          - button
      - row "E2E editable project 1781799705380":
        - cell:
          - button
        - cell "E2E editable project 1781799705380"
        - cell:
          - button
```
