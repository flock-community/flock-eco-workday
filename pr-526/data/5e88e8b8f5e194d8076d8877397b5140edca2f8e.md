...
Locator: locator('tr').filter({ hasText: '25-05-2026' }).filter({ hasText: 'Workflow tester 1781779780074' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('tr').filter({ hasText: '25-05-2026' }).filter({ hasText: 'Workflow tester 1781779780074' }).first()
...
- main:
  ...
  - table:
    - rowgroup:
      - row "Client Assignment From To Days Hours Status":
        - columnheader "Client"
        ...
        - columnheader
    - rowgroup:
      - row "Client D Junior software engineer 01-03-2026 10-03-2026 10 80 REQUESTED":
        - cell "Client D"
        ...
        - cell:
          - button
      - row "Client D Junior software engineer 01-02-2026 10-02-2026 10 80 REQUESTED":
        - cell "Client D"
        - cell "Junior software engineer"
        - cell "01-02-2026"
        - cell "10-02-2026"
        ...
        - cell:
          - button
      - row "Client D Junior software engineer 01-01-2026 10-01-2026 10 80 REQUESTED":
        - cell "Client D"
        - cell "Junior software engineer"
        - cell "01-01-2026"
        - cell "10-01-2026"
