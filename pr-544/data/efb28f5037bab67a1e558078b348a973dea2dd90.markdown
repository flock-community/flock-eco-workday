...
Locator: getByRole('cell', { name: 'E2E editable project 1782390037892 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782390037892 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782390031130":
        - cell:
          - button
        - cell "E2E created project 1782390031130"
        - cell:
          - button
      - row "E2E editable project 1782390037892":
        - cell:
          - button
        - cell "E2E editable project 1782390037892"
        - cell:
          - button
```
