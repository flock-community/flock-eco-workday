...
Locator: getByRole('cell', { name: 'E2E editable project 1782212625657 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782212625657 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782212618019":
        - cell:
          - button
        - cell "E2E created project 1782212618019"
        - cell:
          - button
      - row "E2E editable project 1782212625657":
        - cell:
          - button
        - cell "E2E editable project 1782212625657"
        - cell:
          - button
```
