...
Locator: getByRole('cell', { name: 'E2E editable project 1782804186146 (renamed)' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'E2E editable project 1782804186146 (renamed)' })
  ...
  - table "collapsible table":
    ...
    - rowgroup:
      ...
      - row "Project D":
        ...
        - cell:
          - button
      - row "E2E created project 1782804179235":
        - cell:
          - button
        - cell "E2E created project 1782804179235"
        - cell:
          - button
      - row "E2E editable project 1782804186146":
        - cell:
          - button
        - cell "E2E editable project 1782804186146"
        - cell:
          - button
```
